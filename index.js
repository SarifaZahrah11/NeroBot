...
/////////////////
const BotName = 'NeroBot'; 
const instagram = 'https://instagram.com/muhammadjbalqbaishtma'; 
const telegram = 'https://t.me/jbalh24'; 
const botaktif = 'KETIKA DIAKTIFKAN Oleh Author'; 
const youtube = 'https://youtube.com/reuz_id';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@muhammadjbalqbaishtma`)
})
